    ...
    <main className="h-[100dvh] relative">
      <div className="sm:flex sm:h-full w-full">
        <div className="overflow-hidden sm:w-[50%] sm:h-full">
          ...
          <Image
            className="max-w-[140%]  ml-[-4rem] mt-[-5.3rem] sm:ml-[-10rem] sm:mt-[4rem] sm:max-w-[200%] hidden dark:block"
            src={img_global_map}
            alt=" "
            placeholder="blur"
            loading="lazy"
          />
          <Image
            className="max-w-[140%]  ml-[-4rem] mt-[-5.3rem] sm:ml-[-10rem] sm:mt-[4rem] sm:max-w-[200%]  dark:hidden"
