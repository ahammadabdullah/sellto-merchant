      ...
      <footer className="rounded-t-lg border border-b-0 bg-card/55 text-card-foreground shadow-md sm:shadow-sm  p-10 relative overflow-hidden">
        <div className="top_wrap px-4 flex flex-wrap gap-6 justify-between mb-12">
          <div className="left_wrap  min-[770px]:max-w-[42%] min-[970px]:max-w-[90%]">
            <div className="hover:opacity-60 transition-opacity max-w-[100px] min-w-[90px] sm:max-w-[120px] mb-3">
              <Link href={"/"}>
                <svg
                  className=" w-full  "
                  width="206"
            ...
            <h1 className="font-clash min-[1400px]:text-3xl  text-2xl font-medium">
              Easy digital store solution for everyone
          ...
          <div className="right_wrap flex flex-wrap gap-10 justify-between sm:max-w-[60%] pt-1">
            <div className="links_wrap">
              ...
              <ul className="ml-2 flex flex-col gap-1 text-sm">
                <li className="hover:opacity-100 opacity-70 transition-opacity w-[fit-content]">
                  {" "}
            ...
            <div className="links_wrap">
              ...
              <ul className="ml-2 flex flex-col gap-1 text-sm">
                <li className="hover:opacity-100 opacity-70 transition-opacity w-[fit-content]">
                  Support: <Link href={"/about"}>support@sellto.gg</Link>
                </li>
                <li className="hover:opacity-100 opacity-70 transition-opacity w-[fit-content]">
                  General Inquiry: <Link href={"/pricing"}>info@sellto.gg</Link>
                </li>
                <li className="hover:opacity-100 opacity-70 transition-opacity w-[fit-content]">
                  Phone: <Link href={"/dashboard"}>+02200022223</Link>
                </li>
                <li className="hover:opacity-100 opacity-70 transition-opacity w-[fit-content]">
                  Address: <Link href={"/privacy"}>Rd #8, Tokyo, Japan</Link>
                </li>
              </ul>
            </div>
          </div>
