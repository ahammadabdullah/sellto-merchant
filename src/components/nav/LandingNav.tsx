  ...
  return (
    <nav className="rounded-lg border bg-card/55 text-card-foreground shadow-md sm:shadow-sm p-[.60rem] max-w-[1400px] w-[98%] fixed top-1 sm:top-[1rem] left-[50%] translate-x-[-50%] flex justify-between place-items-center gap-6 z-[1000] backdrop-blur-lg backdrop-saturate-150">
      ...
      <div
        className={cn(
          styles.buttons_wrap,
          "landing_mobile_nav_wrap flex flex-wrap flex-col sm:flex-row justify-end items-end  sm:justify-between place-items-center gap-6 sm:w-full fixed sm:static p-4 pr-5 sm:p-0 pb-16 border sm:border-none"
        )}
      >
        <div className="mobile_nav_logo_wrap flex w-full justify-between px-2 sm:hidden gap-4">
          <Link href={"/"}>
            <svg
              className="max-w-[100px] min-w-[90px] sm:max-w-[120px] hover:opacity-60 transition-opacity"
              width="206"
              height="39"
              viewBox="0 0 206 39"
              fill="none"
